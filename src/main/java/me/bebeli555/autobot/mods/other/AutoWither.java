 ...
 */
//@RegisterMod(displayName = "AutoWither", description = {"Builds a wither to an available spot nearby", "With the best shape and position possible!"}, group = Group.OTHER)
public class AutoWither extends Mods {
