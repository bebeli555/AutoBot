...
public class PacketCanceller extends AutoBot {
	...
	public PacketCanceller() {
		super(Group.OTHER, "PacketCanceller", "Cancel packets. Includes every packet in minecraft 1.12.2", "Also allows you to see received and sent packets");
	}
