...
public class CrystalBlock extends AutoBot {
	...
	public CrystalBlock() {
		super(Group.OTHER, "CrystalBlock", true, "Places obsidian to the best spot between", "You and the end crystal to block damage");
	}
